...
## 구현시 어려웠던 점
         1. C# 자체에 아직 친숙하지 않아 구현을 할 때에 거의 검색과 AI 위주의 바이브코딩을 요하게 됨
         2. 4단계에서의 게임오버 팝업시 모든 버튼 비활성화와 재도전 버튼을 윈도우 팝업에서 구현할려니 힘듦을 느낌
         3. 3단계에서의 크기 축소하는 과정에서 좌표 수정할 때에 머리가 뒤죽박죽되버림
